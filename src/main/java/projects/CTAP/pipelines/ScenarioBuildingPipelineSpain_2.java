...
public class ScenarioBuildingPipelineSpain_2 implements Callable<Integer> {
	...
	private static final Logger log = LogManager.getLogger(ScenarioBuildingPipelineSpain_2.class);

	public static void main(String[] args) {
		System.exit(new CommandLine(new ScenarioBuildingPipelineSpain_2()).execute(args));
	}

...
public class ScenarioBuildingPipelineSpain implements Callable<Integer> {
	...
	private static final Logger log = LogManager.getLogger(ScenarioBuildingPipelineSpain.class);

	public static void main(String[] args) {
		System.exit(new CommandLine(new ScenarioBuildingPipelineSpain()).execute(args));
	}

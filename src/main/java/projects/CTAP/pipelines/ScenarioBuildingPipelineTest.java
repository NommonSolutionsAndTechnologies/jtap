...
public class ScenarioBuildingPipelineTest implements Callable<Integer> {
	...
	private static final Logger log = LogManager.getLogger(ScenarioBuildingPipelineTest.class);

	public static void main(String[] args) {
		System.exit(new CommandLine(new ScenarioBuildingPipelineTest()).execute(args));
	}
